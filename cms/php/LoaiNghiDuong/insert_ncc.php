...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $rs = mysqli_query($conn, "SELECT COUNT(*) AS 'total' FROM loaihinh WHERE MALOAIHINH='" . $malh . "'");
    ...
    if ((int) $row['total'] > 0) {
        ...
        if ($_FILES["uploadInput"]["error"] == UPLOAD_ERR_OK) {
            ...
            $target_file = "../../anhloaihinh/" . $malh . "." . $imageFileType;
            ...
            if (move_uploaded_file($file_tmp, $target_file)) {
                ...
                $res['img'] = "anhloaihinh/" . $malh . "." . $imageFileType;

                // Thực hiện câu lệnh INSERT vào cơ sở dữ liệu
                $sql = "INSERT INTO loaihinh(MALOAIHINH, TENLOAIHINH,MOTALOAIHINH,ANHLOAIHINH,titleloaihinh) VALUES ('" . $malh . "','" . $tenlh . "','" . $mota . "','" . $res['img'] . "','" . $titleloaihinh . "')";
            ...
            // Thực hiện câu lệnh INSERT vào cơ sở dữ liệu
            $sql = "INSERT INTO loaihinh(MALOAIHINH, TENLOAIHINH,MOTALOAIHINH,ANHLOAIHINH,titleloaihinh) VALUES ('" . $malh . "','" . $tenlh . "','" . $mota . "', .'' . ,'" . $titleloaihinh . "')";
            if (mysqli_query($conn, $sql)) {
                if (mysqli_affected_rows($conn) > 0) {
                    $res["success"] = 1; // Thành công
