    ...
    <div class="container body">
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Cập Nhật loại nghỉ dưỡng<small></small></h2>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="malh">Mã loại hình <span class="required">*</span>
                                                </label>
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="tenlh">Tên loại hình <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 ">
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="des">mô tả loại hình <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <!-- <input type="text" id="des" name="last-name" required="required"
                                                        class="form-control"> -->
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="email">tile loại hình <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" id="title" name="last-name" required="required" class="form-control">
                                                </div>
                                            </div>
                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="row">
                            <div class="col-md-12 col-sm-6  ">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Các loại nghỉ dưỡng<small></small></h2>
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Mã loại hình </th>
                                                    <th>Tên loại hình</th>
                                                    <th>mô tả loại hình </th>
                                                    <th>tile loại hình </th>
                                                </tr>
                                            </thead>
                ...
                <script src="xuly_thaotac_loainghiduong.js"></script>
                <script src="xuly_loainghiduong.js"></script>
