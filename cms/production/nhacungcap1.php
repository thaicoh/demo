                ...
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.html" class="site_title"> <img src="images/logo1.png"
                                style="object-fit: cover; width: 30%; height: 80%; border-radius: 50%;" /> <span>Bán
                                hoa</span></a>
                    </div>
                                        ...
                                        <form id="demo-form2" data-parsley-validate=""
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                    for="malh">Mã loại hình <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" id="malh" name="malh" required="required"
                                                        class="form-control ">
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                    for="tenlh">Tên loại hình <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" id="tenlh" name="last-name" required="required"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                    for="des">mô tả loại hình <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <!-- <input type="text" id="des" name="last-name" required="required"
                                                        class="form-control"> -->

                                                    <textarea type="text" id="des" name="des" rows="10"
                                                        style="height: 150px;" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                    for="email">tile loại hình <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" id="title" name="last-name" required="required"
                                                        class="form-control">
                                                </div>
                                            </div>
