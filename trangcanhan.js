...
$(".btncapnhat").click(function (e) {
    ...
    if (!fileName && previewSrc) { // Người dùng không thay đổi hình ảnh
        ...
        var datasend = {
            ...
            gioiTinh: $("#gt").val(),
            matKhauKH: $("#mk").val(),
            anhKH: $("#previewImage").attr("data-anh")
        }

        // gọi hàm update cho datasend ở 2 điều kiện trên
        console.log("datasend: ", datasend);
        queryDataPost("cms/php/TCN/update_khachhang.php", datasend, function (res) {
            if (res.success == 1) {
                /// alert("Thêm thành công");
                alert('Update dữ liệu vào thành công!');
                window.location.reload();   
            } else {
                alert('Update dữ liệu vào thất bại!');
        ...
        fetch('cms/php/TCN/upload_anhkhachhang.php', {
            method: 'POST',
            body: formData
        })
