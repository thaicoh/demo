...
<head>
    ...
    <style>
        ...
        /* <link href="https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/css/bootstrap.min.css" rel="stylesheet"><style type="text/css">body {
            margin-top: 20px;
            color: #1a202c;
            text-align: left;
...
<body>
    ...
    <div class="container-fluid">
        <img src="anh2/Screenshot 2023-06-22 164110.png" alt="" class="w-100">
    </div>
            ...
            <div class="row maunen justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="anh/avatar.jpg" alt="Admin"
                                    class="rounded-circle" width="150">
                                <div class="mt-3">
                                <h4><?php echo $quocgiaData[0]['TENKH']; ?></h4>
                ...
                <div class="col-lg-5 col-12">
                    <div class="control mt-4">
                        <h6>Gmail *</h6>
                        <input class="w-100 hoten" id="ten" type="text" placeholder="" readonly value="<?php echo $quocgiaData[0]['EMAILKH']; ?>"> 
                    ...
                    <div class="control mt-4">
                        <h6>Họ Tên *</h6>
                        <input class="w-100 hoten" id="ten" type="text" placeholder="" value="<?php echo $quocgiaData[0]['TENKH']; ?>"> 
                        <small></small>
                    </div>

                    <div class="control mt-4">
                        <h6>Số Điện Thoại *</h6>
                        <input class="w-100" id="sodienthoai" type="text" placeholder="">
                        <small></small>
                    </div>
                    ...
                    <div class="control mt-4">
                        <h6>Địa chỉ </h6>
                        <input class="w-100" id="diachi" type="text" placeholder="">
                        <small></small>
                    </div>
                ...
                <div class="control col-lg-12 text-center">
                    <button class="btn send mt-4 btn-capnhat">Cập Nhật</button>
                </div>
            </div>
                    ...
                    <div class="nav-item nav-avt text-right col-lg-1 p-0 ml-3 hidden">
                        <div class="avtUser">
                            ...
                            <div class="dropdown-menu menu-user">
                                ...
                                <ul>
                                    <li>
                                        <img src="./assets/icons/user.png" /><a href="trangcanhan.html">Tài khoảng của tôi</a>
                                    </li>
                                    <li>
        ...
        <form class="form_bg " id="form_lienHe">
            <div class="row maunen justify-content-center">
                ...
                <div class="col-lg-5 col-12">
                    <div class="control mt-4">
                        <h6>Gmail *</h6>
                        <input class="w-100" id="email" type="text" placeholder="">
                        <small></small>
                    </div>

                    <div class="control mt-4">
                        <h6>Họ Tên *</h6>
                        <input class="w-100 hoten" id="ten" type="text" placeholder="">
                        <small></small>
                    </div>
